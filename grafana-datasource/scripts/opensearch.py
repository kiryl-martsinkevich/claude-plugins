#!/usr/bin/env python3
"""Fetch OpenSearch data via Grafana datasource proxy. Outputs CSV to stdout."""
...
def parse_args():
    p = argparse.ArgumentParser(
        description='Fetch OpenSearch data via Grafana datasource proxy. Outputs CSV to stdout.')
